...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "درباره قبولینو | مرجع منابع آزمون استخدامی" },
      { name: "description", content: "آشنایی با تیم قبولینو و مأموریت ما در تهیه منابع آزمون‌های استخدامی." },
      { property: "og:title", content: "درباره قبولینو" },
  ...
  component: () => (
    <SiteLayout>
      <div className="container-page max-w-3xl py-12">
        <h1 className="text-2xl font-extrabold">درباره قبولینو</h1>
        <p className="mt-5 text-sm leading-8 text-muted-foreground">
          قبولینو با هدف ساده‌سازی مسیر آمادگی داوطلبان آزمون‌های استخدامی راه‌اندازی شده است. تیم ما شامل
